 Attendees
- Michael (Codeplay), David Weaver (Akeana) , Colin Davidson (Codeplay) Abel Bernabeu( Esperanto), Ali Zaidi (tenstorrent), Rafel Sene (RV staff), 
Ken Dockser (tenstorrent) , Victor Lu (self) Jeff Scheel (RV)
