# Attendees
- Michael, , Yu Bo (PLCT) , John Leidel (Tactical), Jiangang, Guifeng  (intel), Aaron Durbin , Ravi Sahita , Ken DOckser(Rivos)
...
Conferences
 ...
 - Action Items
   ...
   - Build DC software stack slide in our plan
   - Write intro email to invite owners for 2 papers: on software ecosystem, 
   - Connect GuoRen on MM with Earl
