 Attendees
- Michael (Codeplay), David Weaver (Akeana) ,Ali Zaidi (tenstorrent), Rafel Sene (RV staff), 
Ken Dockser (tenstorrent) , Victor Lu (self) Jeff Scheel (RV), ANdrew Jones (ventana)
